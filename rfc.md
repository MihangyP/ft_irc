...
Kalt
middle
trailing%x01-09 / %x0B-0C / %x0E-1F / %x21-39 / %x3B-FF
...
; Command to attempt to connect local
...
Example:
AWAY :Gone to lunch.
Back in 5 ; Command to set away message to
...
Example:
REHASH
; message from user with operator
...
RPL_KILLDONE
RPL_CLOSEEND
RPL_MYPORTIS232RPL_ENDOFSERVICES
316
362
373RPL_WHOISCHANOP
RPL_CLOSING
